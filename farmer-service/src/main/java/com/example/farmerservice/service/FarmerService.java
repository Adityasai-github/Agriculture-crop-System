 ...
 * 
 * @Autowired FarmerRepo repo;
 * 
 * @Override public UserDetails loadUserByUsername(String username) throws
 * UsernameNotFoundException { Farmer foundedfarmer=
 * repo.findFarmerByName(username); if(foundedfarmer ==null) return null; String
 * fname=foundedfarmer.getFname(); String
 * fpassword=foundedfarmer.getFpassword(); return new
 * org.springframework.security.core.userdetails.User(fname,fpassword,new
 * ArrayList<>()); }
 * 
 * 
 * 
